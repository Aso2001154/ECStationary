...
<div id="app">
    <div class="container">
        ...
        <form action="management_re_signup_in.php" method="post">
            <div class="range">
                <h2 class="subtitle">id</h2><p style="margin-left: 25%;"><span class="span">※文字種：アルファベット、数字(半角)の組み合わせ/制限：ハイフン、*、@、/、(、)、<、>、$、#、&、%、!、ひらがな、漢字はなし/文字数：8文字</span></p>
                ...
                <h2 class="subtitle">pass</h2><p style="margin-left: 25%;"><span class="span">※文字種：数字(半角)/制限:ハイフン、*、@、/、(、)、<、>、$、#、&、%、!、アルファベット、ひらがな、漢字はなし/文字数：4文字</span></p>
                ...
                <h2 class="subtitle">credit number</h2><p style="margin-left: 25%;"><span class="span">※文字種：数字(半角)/制限：ハイフンはなし/文字数：16文字</span></p>
