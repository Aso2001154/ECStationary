 ...
 <div class="container">
     <form action="re_information.php" method="post">
         ...
         foreach ($stmt as $row) {
             ...
             echo '<h2 class="subtitle" id="credit_number">credit number</h2><p style="margin-left: 25%;"><span class="span">※文字種：数字(半角)/制限：ハイフンはなし/文字数：16文字</span></p>';
